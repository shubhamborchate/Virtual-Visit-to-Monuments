...
<!-- <button onclick = 'f=window.open("http://localhost/OnePage/i1.php","fenetre","the style (without style tag, example - width=400, height=600, no px")'style="cursor: pointer;">pop up</button> -->
