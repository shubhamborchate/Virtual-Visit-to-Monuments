									...
									<tr>
										...
										<td>
											<?php 
												...
												$sn=mysqli_query($con,"SELECT * FROM add_monuments where m_id=30");
							...
							<div class="col-md-12 text-center" style="padding-bottom:20px">
									...
									<tr>
										...
										<td>
											...
											<input type="hidden" name="amount" id="hm" value="<?php echo $screen['price'];?>"/>
...
<script type="text/javascript">
	$('#seats').change(function(){
		var price=<?php echo $screen['price'];?>;
